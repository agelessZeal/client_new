...
class CustomOption extends Component {
    ...
    render() {
        ...
        const content = (
            ...
            // <Row>
            //     <Col span={12}>
            //         <div className={'variable_area'}>
            //             <Table columns={columns} dataSource={variables} pagination={false} size="small" />
            //         </div>
            //     </Col>
            //     <Col span={12}>
            //         <div className={'variable_area'}>
            //             <Table columns={columns} dataSource={variableSet2} pagination={false} size="small" />
            //         </div>
            //     </Col>
            // </Row>
        ...
        return (
        <Popover placement="top" title={text} content={content} trigger="click" visible={this.state.showPopover} onVisibleChange={this.handleClickChange}>
