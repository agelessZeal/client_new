...
import {draftEditorOptions} from '../../pageData/index.js'
    ...
    render() {
        ...
        const content = (
            <Tabs defaultActiveKey="1">
                <TabPane tab="Buyer Related" key="1">
                    <Table rowKey={record => ids.generate()} columns={columns} dataSource={draftEditorOptions.variableBuyer} pagination={false} size="small" />
                </TabPane>

                <TabPane tab="Order Related" key="2">
                    <Table rowKey={record => ids.generate()} columns={columns} dataSource={draftEditorOptions.orderRelated} pagination={false} size="small" />
                </TabPane>

                <TabPane tab="Shipping Related" key="3">
                    <Table rowKey={record => ids.generate()} columns={columns} dataSource={draftEditorOptions.shippingRelated} pagination={false} size="small" />
                </TabPane>
                <TabPane tab="Links" key="4">
                    <Table rowKey={record => ids.generate()} columns={columns} dataSource={draftEditorOptions.variableLinks} pagination={false} size="small" />
                </TabPane>

                <TabPane tab="My  Logos" key="5">
                    <Table rowKey={record => ids.generate()} columns={columns} dataSource={draftEditorOptions.variableLogos} pagination={false} size="small" />
                </TabPane>
            </Tabs>
