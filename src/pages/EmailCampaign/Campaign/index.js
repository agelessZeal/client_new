...
class EmailCampaignComponents extends React.Component {
  ...
  state = {
    ...
    filtered: false,
      ...
      goToCreateCampaignPage: false
  }

    showCreateCampaign = () => {
        this.setState({
            goToCreateCampaignPage: true
        });
  ...
  render() {
    ...
    let { pager, data, tableData, createCampaignVisible, channels, confirmLoadingCCampaign, editorState, showCampaignPreview, campaignTitle, campaignBody, campaignID, goToCreateCampaignPage } = this.state;
    let campaigns;
    let { getFieldDecorator } = this.props.form

      if(goToCreateCampaignPage){
          return <Redirect to={'/campaigns/add'} />
      }
