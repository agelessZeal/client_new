    ...
    render() {
        ...
        const content = (
            <Tabs defaultActiveKey="1">
                ...
                <TabPane tab="Links" key="4"><Table columns={columns} dataSource={variableLinks} pagination={false} size="small" /></TabPane>
                <TabPane tab="My  Logos" key="5"><Table columns={columns} dataSource={variableLogos} pagination={false} size="small" /></TabPane>
            </Tabs>
